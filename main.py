    ...
    try:
        ...
        if STRIPE_TRADING_PRICE_ID:
            ...
            line_items = [{
                "price_data": {
                    "currency":     "gbp",
                    "unit_amount":  15000,  # £150 early bird (was £300)
                    "recurring":    {"interval": "year"},
                    "product_data": {
                        "name": "AGD Sports Trading Plan",
                        "description": "AGD Sports Trading — Daily pre-match sheets · 6 seasons results database · Poisson model · Steam detection · Trading systems · 50% early bird discount",
                    },
                },
                "quantity": 1,
            }]
