...
def _generate_prematach_sheet() -> bytes:
    ...
    try:
        ...
        for fbd in fbd_data:
            ...
            fixtures.append({
                "home":home,"away":away,"league":fbd.get("league",""),
                "ko":fbd.get("kickoff",""),
        ...
        for ri,fix in enumerate(fixtures,5):
            ...
            row_vals=[
                ...
                "",fix["bfby"],fix["bfbyl"],fix["bfbn"],fix["bfbnl"],
...
async def download_steam_sheet_protected(email: str = ""):
    ...
    try:
        ...
        for fbd in fbd_data:
            ...
            steam_rows.append({
                "home":home,"away":away,"league":fbd.get("league",""),"ko":fbd.get("kickoff",""),
        ...
        for ri,sr in enumerate(steam_rows,5):
            ...
            row_vals=[
                today.strftime("%d/%m/%Y"),sr["ko"],sr["league"],sr["home"],sr["away"],
