...
def _generate_prematach_sheet() -> bytes:
    ...
    try:
        ...
        for fbd in fbd_data:
            ...
            # For each market: use PC-captured price if available, else FBD BF Exchange
...
async def download_steam_sheet_protected(email: str = ""):
    ...
    try:
        ...
        for fbd in fbd_data:
            ...
            def _gm(mkt,t): return mkts.get(mkt,{}).get(t)
            def _mv(p7,p5):
                if p7 and p5:
                    mv=round(p5-p7,2)
        ...
        for ri,sr in enumerate(steam_rows,5):
            ...
            row_vals=[
                ...
                sr["o25_7"],sr["o25_5"],o25_mvs,o25_pcts,o25_ss,
                sr["dr_7"], sr["dr_5"], dr_mvs, dr_pcts, dr_ss,
                sr["fho_7"],sr["fho_5"],fho_mvs,fho_pcts,fho_ss,
                sr["o15_7"],sr["o15_5"],o15_mvs,o15_pcts,o15_ss,
        ...
        try:
            ...
            if _due(tasks["results"] - timedelta(days=1)):
                ...
                try:
                    ...
                    logger.info("✅ Results fetched and cached")
                except Exception as e:
                    logger.error(f"Results fetch error: {e}")
