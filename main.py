...
LEAGUES = [
    ...
    {"code": "CL",  "name": "Champions League", "country": "Europe", "flag": "CL", "crest": "https://crests.football-data.org/CL.png"},
    
    # England
    {"code": "PL",  "name": "Premier League", "country": "England", "flag": "PL", "crest": "https://crests.football-data.org/PL.png"},
    {"code": "ELC", "name": "Championship",   "country": "England", "flag": "PL", "crest": "https://crests.football-data.org/ELC.png"},

    # Spain
    {"code": "PD",  "name": "La Liga", "country": "Spain", "flag": "PD", "crest": "https://crests.football-data.org/PD.png"},

    # Germany
    {"code": "BL1", "name": "Bundesliga", "country": "Germany", "flag": "BL1", "crest": "https://crests.football-data.org/BL1.png"},

    # Italy
    {"code": "SA",  "name": "Serie A", "country": "Italy", "flag": "SA", "crest": "https://crests.football-data.org/SA.svg"},

    # France
    {"code": "FL1", "name": "Ligue 1", "country": "France", "flag": "FL1", "crest": "https://crests.football-data.org/FL1.png"},
