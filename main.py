...
def _generate_prematach_sheet() -> bytes:
    ...
    try:
        ...
        for fbd in fbd_data:
            ...
            bfl  = _mp("home_lay",   None)
            bfa  = _mp("away_back",  "bf_away")
            bfal = _mp("away_lay",   None)
            bfd  = _mp("draw_back",  "bf_draw")
            bfdl = _mp("draw_lay",   None)
            bfo25= _mp("o25_back",   "bf_o25");  bfo25l= _mp("o25_lay",  None)
            bfu25= _mp("u25_back",   "bf_u25")
            bfo15= _mp("o15_back",   "bf_o15");  bfo15l= _mp("o15_lay",  None)
            bfu15= _mp("u15_back",   "bf_u15")
            bfo35= _mp("o35_back",   "bf_o35");  bfo35l= _mp("o35_lay",  None)
            bfu35= _mp("u35_back",   "bf_u35")
            bfo45= _mp("o45_back",   "bf_o45");  bfo45l= _mp("o45_lay",  None)
            bfu45= _mp("u45_back",   "bf_u45")
            bfby = _mp("btts_yes_back","bf_btts_y"); bfbyl= _mp("btts_yes_lay",None)
            bfbn = _mp("btts_no_back", "bf_btts_n"); bfbnl= _mp("btts_no_lay", None)
            bffu05= _mp("fh_u05_back","bf_u05");  bffuo5l= _mp("fh_u05_lay",None)
            bffo05= _mp("fh_o05_back","bf_o05");  bffoo5l= _mp("fh_o05_lay",None)
            bffu15= _mp("fh_u15_back","bf_u15");  bffu15l= _mp("fh_u15_lay",None)
            bffo15= _mp("fh_o15_back","bf_o15");  bffo15l= _mp("fh_o15_lay",None)
        ...
        for ri,fix in enumerate(fixtures,5):
            ...
            for ci,val in enumerate(row_vals[:N],1):
                ...
                if ci==4:
                    ...
                    try:
                        v=float(sv)
                        cx.value=f"{v:+.1f}%" if v else None
